import { User, TransformedData, DepartmentData } from "../types";

export class DataTransformer {
    public transformUsersByDepartment(users: User[]): TransformedData {
    ...
    private calculateAgeRange(ages: number[]): string {
        if (ages.length === 0) return "0-0";
